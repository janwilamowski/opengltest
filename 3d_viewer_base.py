...
""" Blatantly copied and stripped down version of PyASSIMP's 3D viewer
...
class PyAssimp3DViewer:
    ...
    def render_colors(self):
        ...
        if self.scene and self.scene.rootnode:
...
if __name__ == '__main__':
    ...
    main(model=model, width=1024, height=768)
